...
int main() {
    fast_vec::vector<int> test  = {1, 2, 3, 4, 5};
    fast_vec::vector<int> test2 = {1000, 1001, 10002};
    fast_vec::vector<int> test3 = {2000, 2001, 2002, 2003, 2004, 2005, 2006};
    auto print_func = [&]() {
        for (auto val : test) {
            std::cout << val << ' ';
        }
    ...
    fast_vec::vector<int> tmp = {100, 101, 102};
